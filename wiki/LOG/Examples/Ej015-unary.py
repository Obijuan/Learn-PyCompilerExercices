...
# ──  S → o
# ──  S → λ
# Lenguaje a detectar: L = {o, λ}. Es decir, que se
# trata de un 1 unario opcional. Es valido tanto si está
# como si no está
# ──────────────────────────────────────────
...
def S():
    ...
    # -- Ahora S puede generar dos cadenas, bien `o` o bien la nula
    # -- Por tanto hay que decidir cual es la cadena producida
